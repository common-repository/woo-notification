...
class VI_WNOTIFICATION_F_Admin_Settings {
	...
	public function save_meta_boxes() {
		...
		if ( ! wp_verify_nonce( wp_unslash( sanitize_text_field( $_POST['_wnotification_nonce'] ) ), 'wnotification_save_email_settings' ) ) {
			return false;
		}
		if ( ! current_user_can( 'manage_options' ) ) {
			return false;
		...
		foreach ( $data as $key => $value ) {
			if ( in_array( $key, $args ) ) {
				$data[ $key ] = wp_kses_post( $this->stripslashes_deep( $value ) );
			} else {
            ...
            <form method="post" action="" class="vi-ui form">
                ...
                <div class="vi-ui bottom attached tab segment" data-tab="products">
                    ...
                    <table class="optiontable form-table">
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_field( 'enable_out_of_stock_product' ) ) ?>"><?php esc_html_e( 'Out-of-stock products', 'woo-notification' ) ?></label>
                            </th>
                            <td>
                                <div class="vi-ui toggle checkbox">
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_field( 'product_link' ) ) ?>"><?php esc_html_e( 'External link', 'woo-notification' ) ?></label>
                            </th>
                            <td>
                                <div class="vi-ui toggle checkbox">
                ...
                <div class="vi-ui bottom attached tab segment" data-tab="product-detail">
                    ...
                    <table class="optiontable form-table">
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_field( 'notification_product_show_type' ) ) ?>"><?php esc_html_e( 'Notification show', 'woo-notification' ) ?></label>
                            </th>
                            <td>
                ...
                <div class="vi-ui bottom attached tab segment" data-tab="design">
                    ...
                    <table class="optiontable form-table">
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label><?php esc_html_e( 'Image padding', 'woo-notification' ) ?></label>
                            </th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_field( 'rounded_corner' ) ) ?>">
									<?php esc_html_e( 'Rounded corner style', 'woo-notification' ) ?>
                                </label>
                            </th>
                            <td>
                                <div class="vi-ui toggle checkbox">
                        ...
                        <tr valign="top" class="wn-rounded-conner-depending">
                            <th scope="row">
                                <label><?php esc_html_e( 'Custom Rounded corner', 'woo-notification' ) ?></label>
                            </th>
                            <td>
                                <div class="vi-ui form">
                                    <div class="inline fields">
                                ...
                                <p class="description"><?php echo esc_html__( 'This option is used only if you do not select any background templates', 'woo-notification' ) ?></p>
                            </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row">
                        ...
                        <tr valign="top" class="show-close-icon hidden">
                            ...
                            <td>
                                <div class="vi-ui form">
                                    <div class="inline fields">
                                        <input type="number"
                                               name="<?php echo esc_attr( self::set_field( 'time_close' ) ) ?>"
                        ...
                        <tr valign="top" class="show-close-icon vi_hidden">
                            <th scope="row">
                                <label><?php esc_html_e( 'Close icon color', 'woo-notification' ) ?></label>
                            </th>
                            <td>
                ...
                <div class="vi-ui bottom attached tab segment" data-tab="time">
                    ...
                    <table class="optiontable form-table">
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <label for="<?php echo esc_attr( self::set_field( 'initial_delay_random' ) ) ?>"><?php esc_html_e( 'Initial time random', 'woo-notification' ) ?></label>
                            </th>
                            <td>
                                <a class="vi-ui button" target="_blank"
                                   href="https://1.envato.market/djEZj"><?php esc_html_e( 'Update This Feature', 'woo-notification' ) ?></a>
										...
										foreach ( $messages as $k => $message ) {
                                            ...
                                            <tr>
                                                <td width="90%">
                                                    ...
                                                    <textarea
                                                            name="<?php echo esc_attr( self::set_field( 'message_purchased', 1 ) ) ?>"><?php echo strip_tags( wp_kses_post( $message ) ) ?></textarea>
